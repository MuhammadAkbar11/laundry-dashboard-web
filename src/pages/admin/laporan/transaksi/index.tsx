...
export default function LaporanTransaksiPage({ userAuth }: Props) {
  const TITLE = `Laporan Transaksi | ${APP_NAME}`;
  ...
  return (
    <>
      ...
      <Container fluid className="p-0">
        <h1 className="h3 mb-3">Laporan Transaksi</h1>
        <Row className="row">
          <Col xs={12}>
...
LaporanTransaksiPage.layout = AdminLayout;
