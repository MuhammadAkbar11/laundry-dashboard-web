          ...
          <Row className="justify-content-center ">
            <Col xs={12} md={6}>
              <div className="text-center mt-1 font-opensans ">
                ...
                <p className="">
                  Saat ini pesanan Anda telah masuk ke dalam antrian dan sedang
                  diproses. Mohon tunggu konfirmasi lebih lanjut.
                </p>
              </div>
            </Col>
...
OrderSuccesPage.layout = WebMiscLayout;
