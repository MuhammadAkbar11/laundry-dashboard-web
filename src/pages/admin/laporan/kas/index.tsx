...
export default function LaporanKasPage({ userAuth }: Props) {
  const TITLE = `Laporan Kas | ${APP_NAME}`;
  ...
  return (
    <>
      ...
      <Container fluid className="p-0">
        <h1 className="h3 mb-3">Laporan Kas</h1>
        <Row className="row">
          <Col xs={12}>
...
LaporanKasPage.layout = AdminLayout;
