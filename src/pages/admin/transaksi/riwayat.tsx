...
export default function RiwayatTransaksiPage({ userAuth }: Props) {
  const TITLE = `Riwayat Transkasi | ${APP_NAME}`;
  ...
  return (
    <>
      ...
      <Container fluid className="p-0">
        <h1 className="h3 mb-3">Riwayat Transaksi</h1>
        <Row className="row">
          <Col xs={12}>
            {/* <TableUser /> */}
            <TableTransaction typeQueryKey="histories" />
          </Col>
        </Row>
      </Container>
    </>
...
RiwayatTransaksiPage.layout = AdminLayout;
